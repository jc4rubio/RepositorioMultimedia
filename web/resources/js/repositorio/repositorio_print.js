...
//    var barra_operaciones1 = jQuery("<div/>", {
//        id: "operaciones_medio"+medio.id,
//        class: "col-lg-9 col-md-9 col-sm-9 col-xs-9"
//    });
//    
//    var barra_operaciones2 = jQuery("<div/>", {
//        id: "operaciones_medio"+medio.id,
//        class: "col-lg-3 col-md-3 col-sm-3 col-xs-3"
//    });
    
//    // Papelera (Código nuevo)
//    var papelera_id = "papelera_medio"+medio.id;
//    jQuery("<img/>",{
//        id: papelera_id,
//        class: "papeleraMedio",
//        src: "./resources/images/papelera.png",
//        alt: "borrar"   
//    }).appendTo(item);
...
//    barra_operaciones1.appendTo(item);
//    barra_operaciones2.appendTo(item);
...
var addPerfilCompleto = function (perfil) {
        ...
        contenido_html += "<div class='row'>";
            ...
            //contenido_html += "<div class='col-xs-10 col-sm-10 col-md-10 col-lg-8'>";
                ...
                contenido_html += "<div class='col-xs-offset-1 col-sm-offset-1 col-md-offset-1 col-lg-offset-1 texto_justificado_izquierda'>";
                    contenido_html += "<div style='margin-top: 10px; margin-bottom: 10px;'><b>"+descripcion+"</b></div>";
                contenido_html += "</div>";
            contenido_html += "</div>";
        contenido_html += "</div>";
    }
    ...
    // Video
    contenido_html += "<div class='row'>";
    	contenido_html += "<div class='col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2 perfilCompleto'>";
    ...
    contenido_html += "<div class='row'>";
        contenido_html += "<div class='col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2 perfilCompleto'>";
            ...
            contenido_html += "<div class='col-xs-6 col-sm-6 col-md-6 col-lg-6 texto_justificado_izquierda'>";
                contenido_html += "<div>F. Muestreo</div>";
            contenido_html += "</div>";
            contenido_html += "<div class='col-xs-6 col-sm-6 col-md-6 col-lg-6 texto_justificado_izquierda'>";
                contenido_html += "<div><strong>"+freqMuestreo_audio+" Hz</strong></div>";
            contenido_html += "</div>";
            ...
            contenido_html += "<div class='col-xs-6 col-sm-6 col-md-6 col-lg-6 texto_justificado_izquierda'>";
                contenido_html += "<div>Canales</div>";
            contenido_html += "</div>";
            contenido_html += "<div class='col-xs-6 col-sm-6 col-md-6 col-lg-6 texto_justificado_izquierda'>";
